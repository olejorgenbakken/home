...
const DagensDonasjonsvanerStudenter = new Resultat(
  "Studenter",
...
const DagensDonasjonsvanerAndre = new Resultat(
  "Andre",
...
const DagensDonasjonsvanerAlle = new Resultat(
  "Alle",
...
const DagensMarkedTeknologi = new Resultat(
  "Teknologien",
...
const DagensMarkedMarkedet = new Resultat(
  "Markedet",
...
const FerdigPrototypeSluttbrukere = new Resultat(
  "Sluttbrukerne",
